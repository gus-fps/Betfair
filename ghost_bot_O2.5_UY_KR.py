...
MIN_ODDS        = _config["o25_min_odds"]
MAX_ODDS        = _config["o25_max_odds"]
ALLOWED_LEAGUES = _config["o25_allowed_leagues"]
EXCLUDED_TEAMS  = _config["o25_excluded_teams"]
EXCLUDED_TEAMS_SET = set(t.lower() for t in EXCLUDED_TEAMS)

# ==========================================
# 3. LEDGER INITIALIZATION
# ==========================================
CSV_FILE = os.path.join(_script_dir, "paper_trading_ledger_o25.csv")
...
try:
    ...
    raise SystemExit(1)
print("✅ Logged in successfully. Firing up the O2.5 UY+KR strategy engine...\n")
